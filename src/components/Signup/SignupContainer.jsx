          ...
          <div className='col l8 m10 s12 offset-l2 offset-m1'>
            <div className='card'>
              <div className='card-content'>
                ...
                <p>We <b>never</b> use your email for anything other than daily emails and event notifications. If you have any questions feel free to <a href='https://tanachstudy.com/contact'>contact us</a> at your leisure.</p>
              </div>
            </div>
          </div>
        </div>
