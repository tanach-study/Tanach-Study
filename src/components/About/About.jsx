      ...
      <div className="container">
        ...
        <div className="row valign-wrapper">
          ...
          <div className="col l4">
            <div className="col-content">
              <img src="/assets/images/background1.jpg" alt="" className="valign responsive-img"/>
            </div>
          </div>
        </div>
        ...
        <div className="row valign-wrapper">
          <div className="col l4">
            <div className="col-content">
              <img src="/assets/images/background2.jpg" alt="" className="valign responsive-img"/>
            </div>
          </div>
          <div className="col l8">
            <div className="col-content">
        ...
        <div className="row valign-wrapper">
          ...
          <div className="col l4">
            <div className="col-content">
              <img src="/assets/images/background3.jpg" alt="" className="valign responsive-img"/>
            </div>
          </div>
        </div>
      </div>
