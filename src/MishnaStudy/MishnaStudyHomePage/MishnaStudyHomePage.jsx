    ...
    return (
      <main className='container'>
        <section className='section center'>
          ...
          <p>Currently, Mishna Study is studying Introduction Part 10.</p>
          {/* <p>Currently, Mishna Study is studying Seder {segment} Masechet {section} Perek {unit} Mishna {part}.</p> */}
          <Link className='msred-text' to='/mishna-study/mishna/introduction/introduction/1/10'>Click here to go to today&#39;s part</Link>
        </section>
