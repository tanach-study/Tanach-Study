...
function ProgramNavigation(props) {
  return (
      ...
      <ul className='valign-wrapper'>
        ...
        <li className={styles['nav-list-item']}>
          <Link to='/parasha-study' className={styles['nav-link']}>
            <img
              src='https://cdn.tanachstudy.com/assets/images/parasha-study-logo.png'
        ...
        <li className={styles['nav-list-item']}>
          <Link to='/mishna-study' className={styles['nav-link']}>
            <img
              src='https://cdn.tanachstudy.com/assets/images/mishna-study-logo.png'
        ...
        <li className={styles['nav-list-item']}>
          <Link to='/haftara-study' className={styles['nav-link']}>
            <img
              src='https://cdn.tanachstudy.com/assets/images/haftara-study-logo.png'
        ...
        <li className={styles['nav-list-item']}>
          <Link to='/moadim-study' className={styles['nav-link']}>
            <img
              src='https://cdn.tanachstudy.com/assets/images/moadim-study-logo.png'
